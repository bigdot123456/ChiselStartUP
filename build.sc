...
// object mydsptools extends dependencies.dsptools {
//   // def repositoriesTask = T.task { super.repositoriesTask() ++ Seq(
//   //   MavenRepository("https://maven.aliyun.com/repository/central")
//   // ) }
...
// object dsptools extends dependencies.`berkeley-hardfloat`.build.hardfloat {
//   // def repositoriesTask = T.task { super.repositoriesTask() ++ Seq(
//   //   MavenRepository("https://maven.aliyun.com/repository/central")
//   // ) }
...
object top extends CommonModule {
...
object FFT extends CommonModule {
...
object modem extends CommonModule {
...
object SubModule extends CommonModule {
...
object fifo extends CommonModule {
  //override def millSourcePath = os.pwd / "dependencies" 
  override def forkArgs = Seq("-Xmx4G", "-Xss128m")
